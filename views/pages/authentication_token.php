        ...
        <div class="row justify-content-center h-100 align-items-center">
            <div class="col-lg-6">
                <div class="bg-white rounded-3 shadow px-4 py-5">
                    ...
                    <form action=<?php echo getenv('base_url')."actions/authentication_token.php"?> method="POST" class="needs-validation" novalidate>
                        <div class="mb-3">
                            <label for="tokenvalidation" class="form-label">Token</label>
                            <div class="input-group has-validation">

                                <input id="tokenvalidation" class="form-control sr-only" type="number" name="token" required min="1">
